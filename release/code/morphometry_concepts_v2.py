...
def compute_concepts(rgb: np.ndarray, seg: dict):
    ...
    if cyto.sum() > 30:
        ...
        # PER-CELL-RELATIVE inclusion detection. Absolute colour thresholds fire
        # on every cell's pale cytoplasm and are non-specific (proven in
        # prototype). Instead, detect patches that DEVIATE from the cell's OWN
        # cytoplasm colour: Dohle bodies = pale-blue patches whose b* is well
        # below the cytoplasm median.
