...
**GR-Neutro** multi-label setting (7 abnormality classes, 11 morphological
...
| `concept_config_gr_neutro.json` | 11-concept vocabulary + class→concept matrix + constraint matrix C |
