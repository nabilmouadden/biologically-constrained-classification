...
|---|---|--:|--:|--:|--:|
| `joint_cbm_dinobloomB_ft_s42.pt` | **Joint CBM** (separate classifier ∥ concept adapter + constraint) | **0.912** | 0.861 | 0.865 | 0.886 ± 0.014 |
...
| `backbone_baseline_dinobloomB_ft_s42.pt` | **No-concept backbone baseline** (fine-tuned classifier) | **0.907** | 0.865 | 0.868 | 0.890 |
