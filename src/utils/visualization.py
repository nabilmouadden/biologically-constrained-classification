...
def visualize_constraint_matrix(model, class_names=None, save_path=None, data_loader=None, device=None, image_size=224):
    """
    ...
    if data_loader is not None:
        ...
        dummy_input = torch.ones(1, 3, image_size, image_size).to(device)
        with torch.no_grad():
